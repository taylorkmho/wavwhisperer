          ...
          <main className="relative">
            ...
            <div className="pointer-events-none absolute inset-x-0 top-2 z-10 flex w-full flex-wrap items-start justify-between gap-2 px-4">
              <div className="max-w-96 lg:max-w-xl">
                ...
                <div>
                  <button
                    className="pointer-events-auto flex size-12 shrink-0 items-center justify-center rounded-full border-2 border-[#2C1DFF] bg-black px-2 py-2.5 text-sm font-bold text-white transition-colors"
